...
VALUES ('Who are you ?',
        'My name is Guillaume, I’m 43.
        I’m French, I come from north of France, near Lille. I live in Brussels since 2009. I live with my Italian girlfriend In Saint-Gilles. I have no children.
       ...
       ('How did you discover your passion for programming and software development?',
        'Honestly, almost by random. I am not a geek by nature. During the pandemic period, I knew my job was in danger, and I was thinking of doing something else. I’ve started a skills assessment with Bruxelles formation and discovered the code at the end of 2021 with OpenClassRoom and Udemy platforms. I immediately had fun by coding. To be sure of my capacity and to confirm my interest to it, I did a 7 months training at BeCode. And it totally confirms my interest for programming. I traded my video games with codWars or codingGame (even if I sometimes lose my hair). I see programming as a game, always looking for debug, and hardly trying to keep zenitude.'),
       ('How was your experience at Becode during your Junior Developer training?',
        ...
        I most importantly discover that programming is not just coding by yourself. I discovered how to work as a team and the importance of making clear and readable code. We had several team projects (https://github.com/arnoldhaub/getflixProject & https://github.com/Saidi-Naim/Cookie-Clicker ) and I discovered how works Scrum methodology. I also learned how to learn a new code language, how to read documentations… and the importance of staying updated.'),
       ('And what about your full-stack Javascript training at DigitalCity?',
        ...
        I had started to learn javascript at Becode and I wanted to go deeper. The school was more academic but I see a different approach and I continued to progress. The training confirmed me that I was more interested by the back-end (even if I had fun with react) and I felt ready to start my career.'),
       ...
       ('Why would you like to work for the SPF finances?',
        'As already explained, I am looking for a job useful for the society and I also value work-life balance. SPF finance correspond to these values. I am also myself a serious motivated person, curious, very eager to learn. I would be a good rookie for the service. '),
       ('What is your language level?',
        'I am a French native speaker.
        My level in English is B1.2. I’m scared that my English could be one of my weak points according to my application. I have no difficulties to understand but I have still difficulties to speak well. As I know the importance of the English in our domain, I am hardly working on it. I am starting an intensive monthly presential B2 course in January at Eurospeak’s school. I am quite excited that the training is in English, it’s the best way to improve! And I’ve only followed English online courses so I have the programming vocabulary.
